...
def parse_quantity(value: Any) -> int | None:
    """Parse the quantity required for the bulk price"""
...
class UnwrangleClient:
    ...
    def request(self, platform: str, **parameters: str) -> dict[str, Any]:
        ...
        #Construct the endpoint URL with query paramters, if value is not None is a safeguard
        ...
        self.response_history.append(payload) #Reached only after a successful break; unreachable inside the retry loop otherwise.
